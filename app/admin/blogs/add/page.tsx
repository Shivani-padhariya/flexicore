    ...
    <AdminShell>
      <div className="space-y-5 max-w-4xl">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold" style={{ color: '#1a1a1a' }}>{id ? 'Edit' : 'New'} Blog Post</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{ border: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input className={inputCls} style={inputStyle} value={form.title} onChange={e => setForm({ ...form, title: e.target.value })} required placeholder="Enter blog title..." />
              </div>
              ...
              <div>
                ...
                {(existingImage?.url && !imageFile) ? (
                  ...
                  <div className="relative w-48 h-28 rounded-xl overflow-hidden mb-3" style={{ border: '2px solid #c28b5a' }}>
              ...
              <div>
                ...
                <textarea className={`${inputCls} font-mono text-xs resize-none`} style={inputStyle} rows={14}
                  value={form.content} onChange={e => setForm({ ...form, content: e.target.value })}
                  placeholder="<p>Write your blog content here...</p>" required />
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm" style={{ border: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input className={inputCls} style={inputStyle} value={form.tags} onChange={e => setForm({ ...form, tags: e.target.value })} placeholder="surfaces, tiles, design" />
              </div>
              <div className="flex items-center gap-3 mt-2">
                ...
                <label htmlFor="published" className="text-sm font-medium" style={{ color: '#1a1a1a' }}>Publish immediately</label>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <button type="submit" disabled={saving}
              ...
              {saving ? <><Loader2 size={15} className="animate-spin" /> Saving...</> : (id ? 'Update Post' : 'Publish Post')}
            </button>
            <Link href="/admin/blogs"
